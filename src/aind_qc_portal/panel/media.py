    ...
    def parse_reference(self, reference):
        ...
        if "http" in reference:
            ...
            if parsed_url.path.endswith(".png") or parsed_url.path.endswith(".jpg"):
                ...
                iframe_html = f'<iframe id="neuroglancer" src="{reference}" style="height:100%; width:100%" frameborder="0"></iframe>'
            ...
            return _get_s3_asset(self.parent.s3_client, self.parent.s3_bucket, self.parent.s3_prefix + reference)
...
def _parse_type(reference, data):
    ...
    if reference.endswith(".png") or reference.endswith(".jpg"):
        ...
        return pn.pane.HTML(iframe_html, sizing_mode='stretch_both', height=1000)
