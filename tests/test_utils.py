...
class TestUtils(unittest.TestCase):
    ...
    def test_status_html(self):
        self.assertEqual(status_html(Status.PASS), '<span style="color:#1D8649;">Pass</span>')
        self.assertEqual(status_html(Status.PENDING), '<span style="color:#2A7DE1;">Pending</span>')
        self.assertEqual(status_html(Status.FAIL), '<span style="color:#FF5733;">Fail</span>')
    ...
    def test_md_style(self):
        self.assertEqual(md_style(12, "test"), '<span style="font-size:12pt">test</span>')

    def test_qc_color(self):
        self.assertEqual(qc_color("No QC"), "background-color: #FFB71B")
        self.assertEqual(qc_color("Pass"), "background-color: #1D8649")
        self.assertEqual(qc_color("Fail"), "background-color: #FF5733")
        self.assertEqual(qc_color("Pending"), "background-color: #2A7DE1")
